...
from agents.tools import patient_tools
...
db_agent = LlmAgent(
    ...
    instruction=load_instruction(os.path.join(os.path.dirname(__file__), "instructions", "db_agent.txt")),
...
concierge_agent = LlmAgent(
    ...
    instruction=load_instruction(os.path.join(os.path.dirname(__file__), "instructions", "concierge_agent.txt")),
    tools=[
        # google_search,
        load_memory,
        preload_memory,
