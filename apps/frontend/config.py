...
DOCTOR_ASK_API = f"{BACKEND_BASE_URL}/doctor/ask"
DOCTOR_HISTORY_API = f"{BACKEND_BASE_URL}/doctor/ask/history"
DOCTOR_HISTORY_BY_USER_API = f"{BACKEND_BASE_URL}/doctor/history/by_user"
